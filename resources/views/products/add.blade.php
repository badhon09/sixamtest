...
<div class="row">
   <div class="col-lg-12">
      <div class="card">
         <div class="card-body">
            <form action="{{route('products.store')}}" enctype="multipart/form-data" method="post" id="product_form" class="parsley-examples">
               @csrf
               <div class="row">
                  <div class="col-md-12 mb-2">
                     <label  class="form-label">Product Name<span class="text-danger">*</span></label>
                     <input type="text" name="name" parsley-trigger="change" required placeholder="Product Name" class="form-control"  />
                  ...
                  <div class="col-md-12 mb-2">
                    ...
                    <input type="file" name="image" parsley-trigger="change" required placeholder="Product Name" class="form-control"  />
                 </div>
               </div>
               <div class="row mb-2">
                  <div class="col-md-4">
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                     ...
                     <input type="text" name="unit_price" parsley-trigger="change"  placeholder="Unit Price" class="form-control"  />
                  </div>
                  <div class="col-md-6">
                     <label for="userName" class="form-label">Purchase Price<span class="text-danger"></span></label>
                     <input type="text" name="purchase_price" parsley-trigger="change"  placeholder="Purchase Price" class="form-control"  />
                  </div>
                  <div class="col-md-6">
                     <label for="userName" class="form-label">Total Quantty<span class="text-danger"></span></label>
                     <input type="text" name="quantity" parsley-trigger="change"  placeholder="Quantity" class="form-control"  />
                  </div>
               </div>
               <div class="text-end">
                  <a type="submit" class="btn btn-primary waves-effect waves-light" id="btns" onclick="store()" >Submit</a>
